...
#['#990000','#FF6666','#FFB266','#CCCC00','#66FF66',
...
Ancestor 5 -> M. sativa
"""
rearranged_species_block_file = path + '/input/Legume/Msativa.final.block'
rearranged_species_name = 'M.sativa'
rearranged_species_copy_number = 2

outdir = path + '/output/plot/5-Ms/'
