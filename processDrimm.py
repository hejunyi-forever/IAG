...
block_file = 'D:\IAG\dirmmoutput\locks.txt'
drimmSyntenyFile = 'D:\IAG\dirmmoutput\synteny.txt'
outdir = 'D:\IAG\processorthofinder'
chr_number = [8,20,6,8,8,7,7]
sp_list = ['Carietinum','Gmax','Ljaponicus','Msativa','Mtruncatula','Oviciifolia','Psativum']
target_rate = '2:4:2:2:2:2:2'
